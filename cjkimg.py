...
class FontManager(object):
    ...
    def _get_nix_font_path(self, name, style):
        exit = True
        if name == "Microsoft YaHei" and style == "Regular":
            exit = False
            path = "fonts/msyh.ttf"
        elif name == "DejaVu Sans Mono" and style == "Book":
            exit = False
            path = "fonts/DejaVuSansMono.ttf"
        elif name == "AR PL UKai CN" and style == "Book":
            exit = False
            path = "fonts/ukai.ttc"
        elif name == "WenQuanYi Zen Hei" and style == "Regular":
            exit = False
            path = "fonts/wqy-zenhei.ttc"
        elif name == "WenQuanYi Zen Hei Mono" and style == "Medium":
            exit = False
            path = "fonts/wqy-zenhei-mono.ttc"
        elif name == "DejaVu Sans YuanTi Mono" and style == "Regular":
            exit = False
            path = "fonts/DejaVuSansYuanTiMono-Regular.ttf"
        elif name == "DejaVu Sans YuanTi Mono" and style == "Bold":
            exit = False
            path = "fonts/DejaVuSansYuanTiMono-Bold.ttf"
        elif name == "TakaoPGothic" and style == "Regular":
            exit = False
            path = "fonts/TakaoPGothic.ttf"
        if not exit:
            return path
